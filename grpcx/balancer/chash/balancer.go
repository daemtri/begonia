...
// newConsistentHashBalancerBuilder 返回一个 consistentHashBalancerBuilder.
func newConsistentHashBalancerBuilder() balancer.Builder {
	return &consistentHashBalancerBuilder{}
}

// consistentHashBalancerBuilder 实现了 balancer.Builder
type consistentHashBalancerBuilder struct{}

// Build 创建一个 consistentHashBalancer, and starts its scManager.
...
func (b *consistentHashBalancer) scManager() {
	...
	// Oh no,  what if the picker picks the SubConn is resetting?
	go func() {
		for {
